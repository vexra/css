...
const Page = () => {
  ...
  return (
    <Admin sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen}>
      <header className="fixed left-0 right-0 top-0 z-30 bg-white py-2 md:left-72 md:p-4">
        <div className="absolute left-4 top-4 z-50 md:hidden">
          <button onClick={() => setSidebarOpen(!sidebarOpen)}>
            <i className="fa-solid fa-bars-staggered text-2xl"></i>
          </button>
        </div>
        <div className="flex w-full flex-col items-center px-12 md:flex-row md:items-center md:justify-between">
          <h3 className="text-center text-2xl font-semibold text-secondary">
            Payment Information CPC
          </h3>
